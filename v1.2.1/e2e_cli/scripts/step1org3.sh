...
echo
# 因为现在只有一个组织，peer channel update有签名就够了
...
setGlobals 0 2
set -x
peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer0.bgiblockchain.com:7050 --tls --cafile ${ORDERER_CA}
set +x
