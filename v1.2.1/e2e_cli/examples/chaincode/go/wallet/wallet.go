...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if exist {
		return shim.Error(fmt.Sprintf("Wallet %v has existed", system_wallet))
	}
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	return shim.Error("Invalid invoke function name. Expecting 'delete' 'query' 'walletCreate' 'walletPay'") // 'walletAward'
}
